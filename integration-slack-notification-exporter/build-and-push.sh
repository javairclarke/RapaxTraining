...
if [[ ! -f "$SCRIPT_DIR/bin/slack-notification-exporter-processord.py" ]]; then
    echo "ERROR: Cannot find bin/slack-notification-exporter-processord.py"
    exit 1
fi
...
echo "================================================"
echo "Rapax Custom Integration - Build & Push"
echo "================================================"
...
echo "To run:"
echo "  docker run -d \\"
echo "    --name rapax-slack-notification-exporter \\"
...
echo "    -e COMPONENT_ID=slack-notification-exporter-1 \\"
echo "    ${REGISTRY}/${IMAGE_NAME}:${VERSION}"
echo ""
