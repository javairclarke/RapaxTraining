...
# Configuration
IMAGE_NAME="integration-juniper-trap"
...
if [[ ! -f "$SCRIPT_DIR/bin/juniper-trap-processord.py" ]]; then
    echo "ERROR: Cannot find bin/juniper-trap-processord.py"
    exit 1
fi
...
echo "================================================"
echo "Rapax Juniper Integration - Build & Push"
echo "================================================"
...
echo "    -e COMPONENT_ID=juniper-trap-1 \\"
echo "    ${REGISTRY}/${IMAGE_NAME}:${VERSION}"
echo ""
