#!/bin/bash
#
# Build and push integration-zabbix-webhook container
#

set -e

# Configuration
IMAGE_NAME="integration-zabbix-webhook"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --version)
            ...
            ;;
        -h|--help)
            echo "Build and push integration-zabbix-webhook container"
            echo ""
...
echo "=========================================="
echo "Building integration-zabbix-webhook"
echo "=========================================="
