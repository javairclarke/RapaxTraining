...
# Configuration
IMAGE_NAME="integration-zyxel-snmp"
...
if [[ ! -f "$SCRIPT_DIR/bin/zyxel-snmp-pollerd.py" ]]; then
    echo "ERROR: Cannot find bin/zyxel-snmp-pollerd.py"
    exit 1
fi
...
echo "================================================"
echo "Rapax Zyxel Integration - Build & Push"
echo "================================================"
...
echo "    -e COMPONENT_ID=zyxel-snmp-1 \\"
echo "    ${REGISTRY}/${IMAGE_NAME}:${VERSION}"
echo ""
